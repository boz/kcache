...
func TestMonitor(t *testing.T) {
	...
	h := BuildHandler().OnInitialize(func(objs []*corev1.Pod) {
	...
	uh := BuildUnitaryHandler().OnInitialize(func(obj *corev1.Pod) {
...
func testGenObject(ns, name, vsn string) *corev1.Pod {
	return &corev1.Pod{
