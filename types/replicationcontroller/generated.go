...
type CacheReader interface {
	Get(ns string, name string) (*v1.ReplicationController, error)
	List() ([]*v1.ReplicationController, error)
}
...
type BaseHandler interface {
	OnCreate(*v1.ReplicationController)
	OnUpdate(*v1.ReplicationController)
	OnDelete(*v1.ReplicationController)
}

type Handler interface {
	BaseHandler
	OnInitialize([]*v1.ReplicationController)
}

type HandlerBuilder interface {
	OnInitialize(func([]*v1.ReplicationController)) HandlerBuilder
	OnCreate(func(*v1.ReplicationController)) HandlerBuilder
	OnUpdate(func(*v1.ReplicationController)) HandlerBuilder
	OnDelete(func(*v1.ReplicationController)) HandlerBuilder
	Create() Handler
}
...
type UnitaryHandlerBuilder interface {
	OnInitialize(func(*v1.ReplicationController)) UnitaryHandlerBuilder
	OnCreate(func(*v1.ReplicationController)) UnitaryHandlerBuilder
	OnUpdate(func(*v1.ReplicationController)) UnitaryHandlerBuilder
	OnDelete(func(*v1.ReplicationController)) UnitaryHandlerBuilder
	Create() UnitaryHandler
}

type _adapter struct{}

func (_adapter) adaptObject(obj metav1.Object) (*v1.ReplicationController, error) {
	if obj, ok := obj.(*v1.ReplicationController); ok {
		return obj, nil
	}
	return nil, ErrInvalidType
}

func (a _adapter) adaptList(objs []metav1.Object) ([]*v1.ReplicationController, error) {
	var ret []*v1.ReplicationController
...
func (c *cache) Get(ns string, name string) (*v1.ReplicationController, error) {
...
func (c *cache) List() ([]*v1.ReplicationController, error) {
...
func (e event) Resource() *v1.ReplicationController {
	return e.resource
}
...
type baseHandler struct {
	onCreate func(*v1.ReplicationController)
	onUpdate func(*v1.ReplicationController)
	onDelete func(*v1.ReplicationController)
}

type handler struct {
	baseHandler
	onInitialize func([]*v1.ReplicationController)
}
...
func (hb *handlerBuilder) OnInitialize(fn func([]*v1.ReplicationController)) HandlerBuilder {
	hb.onInitialize = fn
	return hb
}

func (hb *handlerBuilder) OnCreate(fn func(*v1.ReplicationController)) HandlerBuilder {
	hb.onCreate = fn
	return hb
}

func (hb *handlerBuilder) OnUpdate(fn func(*v1.ReplicationController)) HandlerBuilder {
	hb.onUpdate = fn
	return hb
}

func (hb *handlerBuilder) OnDelete(fn func(*v1.ReplicationController)) HandlerBuilder {
	hb.onDelete = fn
	return hb
}
...
func (h handler) OnInitialize(objs []*v1.ReplicationController) {
	if h.onInitialize != nil {
		h.onInitialize(objs)
	}
}

func (hb *unitaryHandlerBuilder) OnInitialize(fn func(*v1.ReplicationController)) UnitaryHandlerBuilder {
	hb.onInitialize = fn
	return hb
}

func (hb *unitaryHandlerBuilder) OnCreate(fn func(*v1.ReplicationController)) UnitaryHandlerBuilder {
	hb.onCreate = fn
	return hb
}

func (hb *unitaryHandlerBuilder) OnUpdate(fn func(*v1.ReplicationController)) UnitaryHandlerBuilder {
	hb.onUpdate = fn
	return hb
}

func (hb *unitaryHandlerBuilder) OnDelete(fn func(*v1.ReplicationController)) UnitaryHandlerBuilder {
	hb.onDelete = fn
	return hb
}
...
func (h unitaryHandler) OnInitialize(obj *v1.ReplicationController) {
	if h.onInitialize != nil {
		h.onInitialize(obj)
	}
}

func (h baseHandler) OnCreate(obj *v1.ReplicationController) {
	if h.onCreate != nil {
		h.onCreate(obj)
	}
}

func (h baseHandler) OnUpdate(obj *v1.ReplicationController) {
	if h.onUpdate != nil {
		h.onUpdate(obj)
	}
}

func (h baseHandler) OnDelete(obj *v1.ReplicationController) {
	if h.onDelete != nil {
		h.onDelete(obj)
	}
}
