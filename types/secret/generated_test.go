...
func TestMonitor(t *testing.T) {
	...
	h := BuildHandler().OnInitialize(func(objs []*corev1.Secret) {
	...
	uh := BuildUnitaryHandler().OnInitialize(func(obj *corev1.Secret) {
...
func testGenObject(ns, name, vsn string) *corev1.Secret {
