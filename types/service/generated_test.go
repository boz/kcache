...
func TestMonitor(t *testing.T) {
	...
	h := BuildHandler().OnInitialize(func(objs []*v1.Service) {
	...
	uh := BuildUnitaryHandler().OnInitialize(func(obj *v1.Service) {
...
func testGenObject(ns, name, vsn string) *v1.Service {
	return &v1.Service{
