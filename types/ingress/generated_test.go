...
func TestMonitor(t *testing.T) {
	...
	h := BuildHandler().OnInitialize(func(objs []*v1beta1.Ingress) {
	...
	uh := BuildUnitaryHandler().OnInitialize(func(obj *v1beta1.Ingress) {
...
func testGenObject(ns, name, vsn string) *v1beta1.Ingress {
