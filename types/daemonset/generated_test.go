...
func TestMonitor(t *testing.T) {
	...
	h := BuildHandler().OnInitialize(func(objs []*v1beta1.DaemonSet) {
	...
	uh := BuildUnitaryHandler().OnInitialize(func(obj *v1beta1.DaemonSet) {
...
func testGenObject(ns, name, vsn string) *v1beta1.DaemonSet {
