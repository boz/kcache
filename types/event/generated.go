...
type UnitaryHandlerBuilder interface {
	OnInitialize(func(*v1.Event)) UnitaryHandlerBuilder
	OnCreate(func(*v1.Event)) UnitaryHandlerBuilder
	OnUpdate(func(*v1.Event)) UnitaryHandlerBuilder
	OnDelete(func(*v1.Event)) UnitaryHandlerBuilder
...
func (hb *unitaryHandlerBuilder) OnInitialize(fn func(*v1.Event)) UnitaryHandlerBuilder {
	hb.onInitialize = fn
	return hb
}

func (hb *unitaryHandlerBuilder) OnCreate(fn func(*v1.Event)) UnitaryHandlerBuilder {
	hb.onCreate = fn
	return hb
}

func (hb *unitaryHandlerBuilder) OnUpdate(fn func(*v1.Event)) UnitaryHandlerBuilder {
	hb.onUpdate = fn
	return hb
}

func (hb *unitaryHandlerBuilder) OnDelete(fn func(*v1.Event)) UnitaryHandlerBuilder {
	hb.onDelete = fn
	return hb
}
...
func (h unitaryHandler) OnInitialize(obj *v1.Event) {
	if h.onInitialize != nil {
		h.onInitialize(obj)
	}
}

func (h baseHandler) OnCreate(obj *v1.Event) {
	if h.onCreate != nil {
		h.onCreate(obj)
	}
}

func (h baseHandler) OnUpdate(obj *v1.Event) {
	if h.onUpdate != nil {
		h.onUpdate(obj)
	}
}

func (h baseHandler) OnDelete(obj *v1.Event) {
	if h.onDelete != nil {
		h.onDelete(obj)
	}
}
